...
public class WithArrayListTypeSafety {
  ...
  public static void main (String[] args) {
    ...
    studentList.add(new Student10("Sujit", 1));
    studentList.add(new Student10("Siddharth", 2));
    studentList.add(new Student10("Karanpreet", 3));
    studentList.add("Hari");   // this would lead to runtime type error 
    studentList.add(new Student10("Tricha", 4));
...
class Student10 {
  ...
  public Student10(String name, int rollNumber) {
    this.name = name;
